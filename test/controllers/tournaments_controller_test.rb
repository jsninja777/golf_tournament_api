...
class TournamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tournament" do
    assert_difference("Tournament.count") do
      post tournaments_url, params: { tournament: { course: @tournament.course, name: @tournament.name, start_date: @tournament.start_date } }
    end
  ...
  test "should update tournament" do
    patch tournament_url(@tournament), params: { tournament: { course: @tournament.course, name: @tournament.name, start_date: @tournament.start_date } }
